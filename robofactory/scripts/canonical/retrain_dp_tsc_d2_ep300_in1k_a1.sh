...
#
# Example (TSC d2 wristcam decentralised arm1, 3-step chain):
#   bash scripts/canonical/submit_with_preflights.sh \
#       --train-launcher scripts/canonical/retrain_dp_tsc_d2_ep300_in1k_a1.sh \
#       --dataset /iris/u/mikulrai/data/RoboFactory/zarr_data/ThreeRobotsStackCube-rf_agent1_d2_wristcam_150.zarr \
...
#       --of-zarr /iris/u/mikulrai/data/RoboFactory/zarr_data/ThreeRobotsStackCube-rf_agent1_d2_wristcam_150.zarr \
#       --of-agent-id 1 --of-exp-name tsc-d2-ep300-in1k-a1 \
