...
#     --train-launcher scripts/canonical/resume_dp_tsc_d2_in1k_a0_from285.sh \
#     --ckpt /iris/u/mikulrai/checkpoints/RoboFactory/ThreeRobotsStackCube-rf_agent0_d2_wristcam_150/285.ckpt \
#     --dataset /iris/u/mikulrai/projects/RoboFactory/robofactory/data/zarr_data/ThreeRobotsStackCube-rf_agent0_d2_wristcam_150.zarr \
