...
def main():
    ...
    ap.add_argument('--zarr-a0', default='/iris/u/mikulrai/datasets/multi_robot/RoboFactory/zarr_data/TwoRobotsStackCube-rf_workspace_overfit1_agent0_150.zarr')
    ap.add_argument('--zarr-a1', default='/iris/u/mikulrai/datasets/multi_robot/RoboFactory/zarr_data/TwoRobotsStackCube-rf_workspace_overfit1_agent1_150.zarr')
